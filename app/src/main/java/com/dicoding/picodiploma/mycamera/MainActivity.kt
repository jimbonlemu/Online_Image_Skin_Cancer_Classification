...
import com.dicoding.picodiploma.mycamera.data.api.NetworkConfig
    ...
    private fun uploadImage() {
        currentImageUri?.let { uri ->
            ...
            lifecycleScope.launch {
                try {
                    val networkService = NetworkConfig.connectApiService()
                    val successResponse = networkService.uploadImage(multipartBody)
